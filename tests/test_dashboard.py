...
class TestPerformanceDashboard:
    ...
    def dashboard(self, temp_data_path):
        ...
        with patch('src.core.calibration.dashboard.plt'), patch('src.core.calibration.dashboard.sns'):
    ...
    @patch('src.core.calibration.dashboard.PerformanceDashboard._create_visualizations')
    @patch('src.core.calibration.dashboard.PerformanceDashboard._save_report')
    ...
    @patch('src.core.calibration.dashboard.plt')
